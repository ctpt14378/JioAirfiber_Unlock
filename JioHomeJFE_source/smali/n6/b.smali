...
.field public static volatile c:Ln6/b;
...
.method static constructor <clinit>()V
    ...
    .line 5
    .line 6
    sput-object v0, Ln6/b;->b:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    .line 8
    .line 9
    iput-object v0, p0, Ln6/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
...
.method public static b()Ln6/b;
    ...
    .line 4
    .line 5
    sget-object v0, Ln6/b;->b:Ljava/lang/Object;
...
.method public static g(Landroid/content/ServiceConnection;)Z
    ...
    .line 1
    instance-of p0, p0, Lcom/google/android/gms/common/internal/i1;
...
.method public static final h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 11
    .line 12
    invoke-static {p0, p1, p3, p4, p2}, Ln6/a;->a(Landroid/content/Context;Landroid/content/Intent;ILjava/util/concurrent/Executor;Landroid/content/ServiceConnection;)Z
...
.method public a(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    .line 16
    invoke-virtual/range {v1 .. v8}, Ln6/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public c(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    .line 1
    invoke-static {p2}, Ln6/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 6
    .line 7
    iget-object v0, p0, Ln6/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 22
    .line 23
    invoke-static {p1, v0}, Ln6/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 25
    .line 26
    iget-object p1, p0, Ln6/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    .line 39
    :cond_0
    invoke-static {p1, p2}, Ln6/b;->e(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final d(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 10
    invoke-virtual/range {v0 .. v7}, Ln6/b;->f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
...
.method public final f(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;IZLjava/util/concurrent/Executor;)Z
    ...
    .line 18
    :try_start_0
    invoke-static {p1}, Lq6/d;->a(Landroid/content/Context;)Lq6/c;
    ...
    .line 22
    invoke-virtual {v1, p6, v0}, Lq6/c;->c(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Ln6/b;->g(Landroid/content/ServiceConnection;)Z
    ...
    .line 39
    .line 40
    iget-object p6, p0, Ln6/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
    ...
    :cond_2
    :try_start_1
    invoke-static {p1, p3, p4, p5, p7}, Ln6/b;->h(Landroid/content/Context;Landroid/content/Intent;Landroid/content/ServiceConnection;ILjava/util/concurrent/Executor;)Z
    ...
    .line 79
    iget-object p2, p0, Ln6/b;->a:Ljava/util/concurrent/ConcurrentHashMap;
