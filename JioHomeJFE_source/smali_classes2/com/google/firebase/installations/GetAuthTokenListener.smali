...
# instance fields
.field private final resultTaskCompletionSource:La7/k;
...
# direct methods
.method public constructor <init>(Lcom/google/firebase/installations/Utils;La7/k;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 5
    .line 6
    iput-object p2, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:La7/k;
...
.method public onException(Ljava/lang/Exception;)Z
    ...
    .line 1
    iget-object v0, p0, Lcom/google/firebase/installations/GetAuthTokenListener;->resultTaskCompletionSource:La7/k;
...
.method public onStateReached(Lcom/google/firebase/installations/local/PersistedInstallationEntry;)Z
    ...
    .line 49
    invoke-virtual {v0, p1}, La7/k;->c(Ljava/lang/Object;)V
