...
.method public static synthetic a(Landroid/content/Context;Landroid/content/Intent;ZLa7/j;)La7/j;
    .locals 0

    .line 1
    invoke-static {p0, p1, p2, p3}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->lambda$startMessagingService$2(Landroid/content/Context;Landroid/content/Intent;ZLa7/j;)La7/j;
...
.method private static bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)La7/j;
    .locals 2
    ...
    .line 29
    :cond_0
    invoke-virtual {v0, p1}, Lcom/google/firebase/messaging/WithinAppServiceConnection;->sendIntent(Landroid/content/Intent;)La7/j;
    ...
    .line 55
    .line 56
    invoke-virtual {p0, p1, p2}, La7/j;->k(Ljava/util/concurrent/Executor;La7/c;)La7/j;
...
.method public static synthetic c(La7/j;)Ljava/lang/Integer;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->lambda$bindToMessagingService$3(La7/j;)Ljava/lang/Integer;
...
.method public static synthetic d(La7/j;)Ljava/lang/Integer;
    .locals 0

    .line 1
    invoke-static {p0}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->lambda$startMessagingService$1(La7/j;)Ljava/lang/Integer;
...
.method private static synthetic lambda$bindToMessagingService$3(La7/j;)Ljava/lang/Integer;
    .locals 0
...
.method private static synthetic lambda$startMessagingService$1(La7/j;)Ljava/lang/Integer;
    .locals 0
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
...
.method private static synthetic lambda$startMessagingService$2(Landroid/content/Context;Landroid/content/Intent;ZLa7/j;)La7/j;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    .line 6
    .line 7
    invoke-virtual {p3}, La7/j;->n()Ljava/lang/Object;
    ...
    .line 22
    :cond_0
    invoke-static {p0, p1, p2}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)La7/j;
...
# virtual methods
.method public process(Landroid/content/Intent;)La7/j;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 23
    .line 24
    invoke-virtual {p0, v0, p1}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->startMessagingService(Landroid/content/Context;Landroid/content/Intent;)La7/j;
...
.method public startMessagingService(Landroid/content/Context;Landroid/content/Intent;)La7/j;
    .locals 5
    ...
    .line 35
    .line 36
    invoke-static {p1, p2, v1}, Lcom/google/firebase/messaging/FcmBroadcastProcessor;->bindToMessagingService(Landroid/content/Context;Landroid/content/Intent;Z)La7/j;
    ...
    .line 47
    .line 48
    invoke-static {v0, v2}, La7/m;->c(Ljava/util/concurrent/Executor;Ljava/util/concurrent/Callable;)La7/j;
    ...
    .line 58
    .line 59
    invoke-virtual {v0, v2, v3}, La7/j;->l(Ljava/util/concurrent/Executor;La7/c;)La7/j;
