...
.method public b(Ljava/lang/Runnable;)Llf/b;
    ...
    .line 4
    invoke-virtual {p0, p1, v0, v1, v2}, Lio/reactivex/internal/schedulers/e;->c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Llf/b;
...
.method public e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Lpf/a;)Lio/reactivex/internal/schedulers/ScheduledRunnable;
    .locals 3
    ...
    .line 6
    .line 7
    invoke-direct {v0, p1, p5}, Lio/reactivex/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lpf/a;)V
    ...
    .line 11
    .line 12
    invoke-interface {p5, v0}, Lpf/a;->b(Llf/b;)Z
    ...
    .line 45
    .line 46
    invoke-interface {p5, v0}, Lpf/a;->a(Llf/b;)Z
...
.method public f(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Llf/b;
    .locals 3
...
.method public g(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Llf/b;
    .locals 8
    ...
    .line 12
    .line 13
    iget-object p5, p0, Lio/reactivex/internal/schedulers/e;->a:Ljava/util/concurrent/ScheduledExecutorService;

    .line 14
    .line 15
    invoke-direct {p4, p1, p5}, Lio/reactivex/internal/schedulers/b;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 37
    :goto_0
    invoke-virtual {p4, p1}, Lio/reactivex/internal/schedulers/b;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
