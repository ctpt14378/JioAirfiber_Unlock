...
.method static constructor <clinit>()V
    ...
    .line 6
    sput-object v0, Lio/reactivex/internal/schedulers/h;->f:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    .line 39
    .line 40
    sput-object v2, Lio/reactivex/internal/schedulers/h;->e:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/h;->d:Ljava/util/concurrent/atomic/AtomicReference;

    .line 4
    iput-object p1, p0, Lio/reactivex/internal/schedulers/h;->c:Ljava/util/concurrent/ThreadFactory;

    .line 5
    invoke-static {p1}, Lio/reactivex/internal/schedulers/h;->g(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;
...
.method public b()Lkf/r$c;
    ...
    .line 2
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/schedulers/h;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public e(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Llf/b;
    .locals 3
    ...
    .line 2
    .line 3
    invoke-static {p1}, Luf/a;->t(Ljava/lang/Runnable;)Ljava/lang/Runnable;
    ...
    .line 16
    :try_start_0
    iget-object p1, p0, Lio/reactivex/internal/schedulers/h;->d:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public f(Ljava/lang/Runnable;JJLjava/util/concurrent/TimeUnit;)Llf/b;
    .locals 8
    ...
    .line 10
    .line 11
    iget-object p4, p0, Lio/reactivex/internal/schedulers/h;->d:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 18
    .line 19
    new-instance p5, Lio/reactivex/internal/schedulers/b;

    .line 20
    .line 21
    invoke-direct {p5, p1, p4}, Lio/reactivex/internal/schedulers/b;-><init>(Ljava/lang/Runnable;Ljava/util/concurrent/ExecutorService;)V
    ...
    .line 39
    :goto_0
    invoke-virtual {p5, p1}, Lio/reactivex/internal/schedulers/b;->b(Ljava/util/concurrent/Future;)V
    :try_end_0
    .catch Ljava/util/concurrent/RejectedExecutionException; {:try_start_0 .. :try_end_0} :catch_0
