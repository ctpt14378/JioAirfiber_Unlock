...
.method public final e()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `AnayliticsEventTable` SET `messageId` = ?,`messageType` = ?,`topicName` = ?,`deviceID` = ?,`sourceId` = ?,`timestamp` = ?,`campaignId` = ?,`regId` = ?,`serialNo` = ?,`modelName` = ?,`msgViewed` = ?,`msgClicked` = ?,`eventName` = ?,`eventCategory` = ?,`sourceType` = ?,`ntType` = ?,`notificationID` = ?,`reqTms` = ?,`reqDate` = ?,`anaTopicName` = ? WHERE `messageId` = ?"
...
.method public final i(Lv3/k;Ljava/lang/Object;)V
    ...
    .line 221
    :goto_d
    iget-object v0, p2, Lcom/jio/push/RoomDB/CDNClientLogTable;->topicName:Ljava/lang/String;
