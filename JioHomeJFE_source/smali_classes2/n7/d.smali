...
.method public static a(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0, p1, v0, v0}, Ln7/d;->b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
...
.method public static b(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;II)Landroid/graphics/drawable/Drawable;
    ...
    .line 9
    .line 10
    invoke-static {p0, p1}, Ln7/d;->h(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
    ...
    .line 15
    .line 16
    invoke-static {p0, p1}, Ln7/d;->g(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)I
...
.method public static c(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;)Landroid/graphics/drawable/Drawable;
    ...
    .line 2
    invoke-static {p0, p1, p2, v0}, Ln7/d;->d(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
...
.method public static d(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;Landroid/graphics/PorterDuff$Mode;Z)Landroid/graphics/drawable/Drawable;
    ...
    .line 6
    .line 7
    invoke-static {p0}, Li2/a;->r(Landroid/graphics/drawable/Drawable;)Landroid/graphics/drawable/Drawable;
    ...
    .line 16
    .line 17
    invoke-static {p0, p2}, Li2/a;->p(Landroid/graphics/drawable/Drawable;Landroid/graphics/PorterDuff$Mode;)V
...
.method public static f(Landroid/graphics/drawable/Drawable;)Landroid/content/res/ColorStateList;
    ...
    .line 21
    .line 22
    invoke-static {p0}, Ln7/a;->a(Ljava/lang/Object;)Z
    ...
    .line 27
    .line 28
    invoke-static {p0}, Ln7/b;->a(Ljava/lang/Object;)Landroid/graphics/drawable/ColorStateListDrawable;
    ...
    .line 32
    invoke-static {p0}, Ln7/c;->a(Landroid/graphics/drawable/ColorStateListDrawable;)Landroid/content/res/ColorStateList;
...
.method public static j(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    .line 6
    .line 7
    invoke-static {p0, p1}, Ln7/d$b;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    ...
    .line 15
    :try_start_0
    invoke-static {p0, p1}, Ln7/d$a;->a(Landroid/graphics/Outline;Landroid/graphics/Path;)V
    :try_end_0
...
.method public static k(Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 7
    .line 8
    invoke-static {p0, p1}, Li2/a;->n(Landroid/graphics/drawable/Drawable;I)V
    ...
    .line 13
    invoke-static {p0, p1}, Li2/a;->o(Landroid/graphics/drawable/Drawable;Landroid/content/res/ColorStateList;)V
