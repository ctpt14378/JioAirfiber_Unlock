...
.method public e()Ljava/lang/String;
    ...
    .line 1
    const-string v0, "UPDATE OR ABORT `Apis` SET `rowId` = ?,`fcmRegistration` = ?,`analytics` = ?,`secondaryId` = ?,`createTag` = ?,`topicSubscription` = ?,`topicUnsubscription` = ?,`appToken` = ?,`inApp` = ?,`nativeDisplay` = ?,`authServerUrl` = ?,`v2Analytics` = ? WHERE `rowId` = ?"
...
.method public bridge synthetic i(Lv3/k;Ljava/lang/Object;)V
    ...
    .line 2
    .line 3
    invoke-virtual {p0, p1, p2}, Lob/b$c;->k(Lv3/k;Lcom/jio/analytics/model/Apis;)V
...
.method public k(Lv3/k;Lcom/jio/analytics/model/Apis;)V
    .locals 4
    ...
    .line 142
    :goto_a
    iget-object v0, p2, Lcom/jio/analytics/model/Apis;->l:Ljava/lang/String;
    ...
    .line 155
    :goto_b
    iget-object p2, p2, Lcom/jio/analytics/model/Apis;->a:Ljava/lang/Integer;
